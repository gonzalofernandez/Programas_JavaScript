...
var miApp = (function () {
    //DATOS DEL SISTEMA
        ...
        function Cuenta(nombreCuenta, nombreUsuario, fechaIngreso, saldo, puntos, tipoCuenta) {
            ...
            this.saldo = !saldo ? SALDO_INICIAL : saldo;
            this.puntos = puntos;
        ...
        SISTEMA_PRINCIPAL.servidores[0].cuentas.push(new Cuenta("g1", "g f", "17/02/77", 20, 10, "newbie"),
                                                    new Cuenta("g2", "g f", "17/02/77", 10, 10, "user"));
        SISTEMA_PRINCIPAL.servidores[2].cuentas.push(new Cuenta("g3", "g f", "17/02/77", 30, 30, "premium"),
                                                    new Cuenta("g4", "g f", "17/02/77", 0, 40, "newbie"));
        SISTEMA_PRINCIPAL.servidores[4].cuentas.push(new Cuenta("g5", "g f", "17/02/77", 10, 60, "user"),
                                                    new Cuenta("g6", "g f", "17/02/77", 20, 60, "newbie"));
        SISTEMA_PRINCIPAL.servidores[5].cuentas.push(new Cuenta("g7", "g f", "17/02/77", 15, 70, "premium"),
                                                    new Cuenta("g8", "g f", "17/02/77", 15, 100, "newbie"));
        ...
        Sistema.prototype.ingresarCuentas = function (nuevaCuenta, servidorElegido) {

...
describe("Testeando la función \"vigenere\" con estilo BDD", function () {
    ...
    it("Debería devolver la cadena cifrada: !hodejfptgn! si introducimos la cadena: *aAsecretzz* y la clave: hola", function () {
        vigenere("*aAsecretzz*", "hola").should.be.equal("!hodejfptgn!");
    });
});

...
describe("Testeando la función \"validateuserdata\" con estilo BDD", function () {
    ...
    it("Debería devolver mensaje indicando que no hemos podido devolver sus datos", function () {
        validateUserData("?nif=22222222J&password=KDSLWQ&name=Enrique%20Gonz%C3%A1lez&gender=M&date=03apr90").should.be.equal("No hemos podido localizar sus datos Sr. González. Su edad es 26 años");
    });
    it("Debería devolver mensaje saludando", function () {
        validateUserData("?nif=12345678Z&password=CAQARIO").should.be.equal("Buenos noches Sr. Pérez. Su edad es 26 años");
    });
    ...
    it("Debería indicar error para argumentos válidos pero no hay password", function () {
        validateUserData("?nif=22222222J&name=Enrique%20González&gender=M&date=03apr90").should.be.equal("No hemos podido localizar sus datos Sr. González. Su edad es 26 años");
    });
